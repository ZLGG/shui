...
public class CodeGenerator {
    public static void main(String[] args) {
        ...
        packageConfig.setEntity("biz.support.commodity.entity");
        packageConfig.setMapper("biz.support.commodity.mapper");
        packageConfig.setService("biz.support.commodity.repository");
        packageConfig.setServiceImpl("biz.support.commodity.repository.impl");
