...
public interface GoodsInfoMapper extends BaseMapper<GoodsInfo> {
    ...
    @Select(
            "SELECT DISTINCT gs.id,gs.merchant_id,gs.shop_id,gs.brand_id,gs.spec_info_id,gs.attribute_info_id," +
                    ...
                    "gs.cost_price,gs.goods_weight,gs.goods_valid_days,gs.goods_image,gs.is_single,gs.point_price,gs.remarks,gs.is_point_good,gs.is_in_member_gift,gs.in_member_point_price,gs.sale_type,\n" +
