...
* @since 2021-01-08
*/
public abstract class BbbH5MarketMerchantCardUsersDTO implements Serializable {

    @Data
    @ApiModel("BbbH5MarketMerchantCardUsersDTO.ETO")
    ...
    @Data
    @ApiModel("BbbH5MarketMerchantCardUsersDTO.IdDTO")
    @AllArgsConstructor
