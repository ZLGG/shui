...
* @since 2020-12-17
*/
public abstract class PCMerchTradeRightsRecordDTO implements Serializable {

    @Data
    @ApiModel("PCMerchTradeRightsRecordDTO.ETO")
    ...
    @Data
    @ApiModel("PCMerchTradeRightsRecordDTO.IdDTO")
    @AllArgsConstructor
