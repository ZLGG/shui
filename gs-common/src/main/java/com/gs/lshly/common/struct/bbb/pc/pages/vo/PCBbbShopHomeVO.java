...
* @since 2020-10-13
*/
public abstract class PCBbbShopHomeVO implements Serializable {
    ...
    @Data
    @ApiModel("PCBbbShopHomeVO.FloorVO")
    @Accessors(chain = true)
    ...
    @Data
    @ApiModel("PCBbbShopHomeVO.FloorListVO")
    @Accessors(chain = true)
    public static class FloorListVO implements Serializable{
    ...
    @Data
    @ApiModel("PCBbbShopHomeVO.FloorGoodsListVO")
    @Accessors(chain = true)
    public static class FloorGoodsListVO implements Serializable{
    ...
    @Data
    @ApiModel("PCBbbShopHomeVO.ShopServiceVO")
    @Accessors(chain = true)
