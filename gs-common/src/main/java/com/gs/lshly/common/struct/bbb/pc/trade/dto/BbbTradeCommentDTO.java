...
* @since 2020-11-06
*/
public abstract class BbbTradeCommentDTO implements Serializable {

    @Data
    @ApiModel("BbbTradeCommentDTO.ETO")
    ...
    @Data
    @ApiModel("BbbTradeCommentDTO.IdDTO")
    @AllArgsConstructor
    ...
    @Data
    @ApiModel("BbbTradeCommentDTO.GoodsIdDTO")
    @AllArgsConstructor
