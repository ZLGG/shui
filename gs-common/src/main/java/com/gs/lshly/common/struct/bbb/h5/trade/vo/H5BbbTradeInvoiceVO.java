...
* @since 2021-01-15
*/
public abstract class H5BbbTradeInvoiceVO implements Serializable {

    @Data
    @ApiModel("H5BbbTradeInvoiceVO.ListVO")
    ...
    @Data
    @ApiModel("H5BbbTradeInvoiceVO.DetailVO")
    ...
    @Data
    @ApiModel("H5BbbTradeInvoiceVO.AddressDateVO")
    @Accessors(chain = true)
    ...
    @Data
    @ApiModel("H5BbbTradeInvoiceVO.ApplyInvoiceVO")
    @Accessors(chain = true)
