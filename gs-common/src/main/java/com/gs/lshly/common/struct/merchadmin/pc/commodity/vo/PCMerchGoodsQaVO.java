 ...
 */
public abstract class PCMerchGoodsQaVO implements Serializable {

    @Data
    @ApiModel("PCMerchGoodsQaVO.ListVO")
    ...
    @Data
    @ApiModel("PCMerchGoodsQaVO.ReplyListVO")
    public static class ReplyListVO extends ListVO {
    ...
    @Data
    @ApiModel("PCMerchGoodsQaVO.DetailVO")
