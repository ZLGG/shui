...
* @since 2020-11-20
*/
public abstract class BbbTradeCancelDTO implements Serializable {

    @Data
    @ApiModel("BbbTradeCancelDTO.ETO")
    ...
    @Data
    @ApiModel("BbbTradeCancelDTO.IdDTO")
    @AllArgsConstructor
    ...
    @Data
    @ApiModel("BbbTradeCancelDTO.CancelDTO")
    @AllArgsConstructor
