...
* @since 2020-10-15
*/
public abstract class BbbOrderRegoodsVO implements Serializable {

    @Data
    @ApiModel("BBB.OrderRegoodsVO.ListVO")
    @Accessors(chain = true)
    public static class ListVO implements Serializable{

        @ApiModelProperty("退货单号(ID)")
        private String id;
    ...
    @Data
    @ApiModel("BBB.OrderRegoodsVO.DetailVO")
