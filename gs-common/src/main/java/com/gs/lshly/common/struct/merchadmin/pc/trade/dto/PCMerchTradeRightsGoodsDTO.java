...
* @since 2020-12-17
*/
public abstract class PCMerchTradeRightsGoodsDTO implements Serializable {

    @Data
    @ApiModel("PCMerchTradeRightsGoodsDTO.ETO")
    ...
    @Data
    @ApiModel("PCMerchTradeRightsGoodsDTO.IdDTO")
    @AllArgsConstructor
