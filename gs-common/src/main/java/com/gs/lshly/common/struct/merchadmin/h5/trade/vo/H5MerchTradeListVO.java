...
* @since 2020-10-28
*/
public abstract class H5MerchTradeListVO implements Serializable {


    @Data
    @ApiModel("H5MerchTradeListVO.tradeVO")
    ...
    public static class tradeVO implements Serializable{
        ...
        List<H5MerchTradeListVO.TradeGoodsVO> tradeGoodsVOS;

    }

    @Data
    @ApiModel("H5MerchTradeListVO.innerGoodsIdAndName")
    @Accessors(chain = true)
    ...
    @Data
    @ApiModel("H5MerchTradeListVO.TradeGoodsVO")
    @Accessors(chain = true)
    ...
    @Data
    @ApiModel("H5MerchTradeListVO.stateCount")
