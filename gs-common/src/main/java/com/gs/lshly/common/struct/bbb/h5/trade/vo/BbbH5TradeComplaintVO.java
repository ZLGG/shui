...
* @since 2020-12-23
*/
public abstract class BbbH5TradeComplaintVO implements Serializable {

    @Data
    @ApiModel("BbbH5TradeComplaintVO.ListVO")
    ...
    @Data
    @ApiModel("BbbH5TradeComplaintVO.DetailListVO")
    ...
    @Data
    @ApiModel("BbbH5TradeComplaintVO.DetailVO")
