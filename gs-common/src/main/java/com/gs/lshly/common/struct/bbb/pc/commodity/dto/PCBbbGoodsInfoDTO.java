...
* @since 2020-10-23
*/
public abstract class PCBbbGoodsInfoDTO implements Serializable {

    @Data
    @ApiModel("PCBbbGoodsInfoDTO.ETO")
    ...
    @Data
    @ApiModel("PCBbbGoodsInfoDTO.IdDTO")
    @AllArgsConstructor
    ...
    @Data
    @ApiModel("PCBbbGoodsInfoDTO.WholesalePriceDTO")
