...
* @since 2020-12-23
*/
public abstract class PCBbbTradeComplaintDTO implements Serializable {

    @Data
    @ApiModel("PCBbbTradeComplaintDTO.ETO")
    ...
    @Data
    @ApiModel("PCBbbTradeComplaintDTO.DetailEto")
    ...
    @Data
    @ApiModel("PCBbbTradeComplaintDTO.IdDTO")
    @AllArgsConstructor
    ...
    @Data
    @ApiModel("PCBbbTradeComplaintDTO.CancelIdeaDTO")
