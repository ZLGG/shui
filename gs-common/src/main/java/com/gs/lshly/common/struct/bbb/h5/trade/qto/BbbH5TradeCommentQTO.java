...
* @since 2020-11-06
*/
public abstract class BbbH5TradeCommentQTO implements Serializable {

    @Data
    @ApiModel("BbcTradeCommentQTO.QTO")
    ...
    @Data
    @ApiModel("BbcTradeCommentQTO.CommentList")
    @Accessors(chain = true)
    public static class CommentList extends BaseQTO {
