...
* @since 2021-2-1
*/
public abstract class H5MerchTradeRightsDTO implements Serializable {

    @Data
    @ApiModel("H5MerchTradeRightsDTO.ETO")
    ...
    @Data
    @ApiModel("H5MerchTradeRightsDTO.IdDTO")
    @AllArgsConstructor
    ...
    @Data
    @ApiModel("H5MerchTradeRightsDTO.IdCheckDTO")
    @AllArgsConstructor
    ...
    @Data
    @ApiModel("H5MerchTradeRightsDTO.SendDTO")
    @AllArgsConstructor
