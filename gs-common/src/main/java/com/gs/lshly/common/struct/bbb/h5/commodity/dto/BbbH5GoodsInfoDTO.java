...
* @since 2020-10-23
*/
public abstract class BbbH5GoodsInfoDTO implements Serializable {
    ...
    @Data
    @ApiModel("BbcGoodsInfoDTO.IdAndShopIdDTO")
    public static class IdAndShopIdDTO extends BaseDTO {
    ...
    @Data
    @ApiModel("BbcGoodsInfoDTO.WholesalePriceDTO")
    public static class WholesalePriceDTO extends BaseDTO {

        @ApiModelProperty(value = "skuID")
        private String skuId;

        @ApiModelProperty("sku商品阶梯价")
        private List<BbbH5GoodsInfoVO.GoodsStepPriceVO> skuStepPrice;

        @ApiModelProperty(value = "sku商品售价")
