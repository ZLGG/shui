...
* @since 2020-10-16
*/
public abstract class BbbH5GoodsQaVO implements Serializable {

    @Data
    @ApiModel("BbbH5GoodsQaVO.ListVO")
    ...
    @Data
    @ApiModel("BbbH5GoodsQaVO.ShowListVO")
    public static class ShowListVO extends ListVO {

        @ApiModelProperty("商品问答统计")
        private BbbH5GoodsQaVO.CountQuizVO countQuizVO;
    ...
    @Data
    @ApiModel("BbbH5GoodsQaVO.DetailVO")
