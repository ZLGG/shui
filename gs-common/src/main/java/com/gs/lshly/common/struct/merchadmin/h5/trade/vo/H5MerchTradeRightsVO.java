...
* @since 2020-12-17
*/
public abstract class H5MerchTradeRightsVO implements Serializable {

    @Data
    @ApiModel("H5MerchTradeRightsVO.ListVO")
    ...
    @Data
    @ApiModel("H5MerchTradeRightsVO.DetailVO")
    @AllArgsConstructor
    @NoArgsConstructor
    public static class DetailVO extends ListVO {
        ...
        private List<H5MerchTradeRightsVO.RightGoodsList> rightGoodsList;
    }
    @Data
    @Accessors(chain = true)
    @ApiModel("H5MerchTradeRightsVO.RightList")
    ...
    @Data
    @Accessors(chain = true)
    @ApiModel("H5MerchTradeRightsVO.RightGoodsList")
    public static class RightGoodsList implements Serializable {
