...
* @since 2020-11-20
*/
public abstract class BbbH5TradeCancelDTO implements Serializable {

    @Data
    @ApiModel("BbcTradeCancelDTO.ETO")
    ...
    @Data
    @ApiModel("BbcTradeCancelDTO.IdDTO")
    @AllArgsConstructor
    ...
    @Data
    @ApiModel("BbcTradeCancelDTO.CancelDTO")
    @AllArgsConstructor
    public static class CancelDTO extends BaseDTO {
