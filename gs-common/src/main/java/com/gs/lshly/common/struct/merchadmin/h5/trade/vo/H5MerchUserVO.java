...
* @since 2020-10-20
*/
public abstract class H5MerchUserVO implements Serializable {

    @Data
    @ApiModel("H5MerchUserVO.ListVO")
    ...
    @Data
    @ApiModel("H5MerchUserVO.PrivateUserDetailVO")
    ...
    @Data
    @ApiModel("H5MerchUserVO.ApplyListVO")
    @Accessors(chain = true)
    ...
    @Data
    @ApiModel("H5MerchUserVO.ApplyPrivateUserDetailVO")
    ...
    @Data
    @ApiModel("H5MerchUserVO.ExportVO")
    ...
    @Data
    @ApiModel("H5MerchUserVO.UserSimpleVO")
