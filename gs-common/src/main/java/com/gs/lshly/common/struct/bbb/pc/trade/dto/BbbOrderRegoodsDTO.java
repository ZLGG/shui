...
* @since 2020-10-15
*/
public abstract class BbbOrderRegoodsDTO implements Serializable {

    @Data
    @ApiModel("BBB.OrderRegoodsDTO.ETO")
    @Accessors(chain = true)
    public static class ETO extends BaseDTO {

        @ApiModelProperty(value = "退货单号(ID)",hidden = true)
        private String id;
    ...
    @Data
    @ApiModel("BBB.OrderRegoodsDTO.IdDTO")
    @AllArgsConstructor
    public static class IdDTO extends BaseDTO {

        @ApiModelProperty(value = "退货单号(ID)")
        private String id;
    }
