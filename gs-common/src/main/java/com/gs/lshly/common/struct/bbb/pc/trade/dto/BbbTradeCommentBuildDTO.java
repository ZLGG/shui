...
* @since 2020-11-06
*/
public abstract class BbbTradeCommentBuildDTO implements Serializable {

    @Data
    @ApiModel("BbbTradeCommentBuildDTO.CommentBuildDTO")
    @AllArgsConstructor
    @NoArgsConstructor
    ...
    @Data
    @ApiModel("BbbTradeCommentBuildDTO.AdditionalDTO")
    @Accessors(chain = true)
