...
* @since 2020-12-01
*/
public abstract class H5MerchMarketPtActivityMerchantDTO implements Serializable {

    @Data
    @ApiModel("H5MerchMarketPtActivityMerchantDTO.ETO")
    ...
    @Data
    @ApiModel("H5MerchMarketPtActivityMerchantDTO.IdDTO")
    @AllArgsConstructor
