...
* @since 2020-11-16
*/
public abstract class TradeGoodsDTO implements Serializable {

    @Data
    @ApiModel("TradeGoodsDTO.ETO")
    ...
    @Accessors(chain = true)
    public static class GoodsSale extends BaseDTO {
