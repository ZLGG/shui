 ...
 * @author zhaoqiang
 * @Description
 * @date 2020/12/22 下午5:50
 */

public abstract class AccountConsumeReturnParamsDTO implements Serializable {

    @Data
    @ApiModel("AccountConsumeReturnParamsDTO.DTO")
    ...
    @Data
    @ApiModel("AccountConsumeReturnParamsDTO.ETO")
    @Accessors(chain = true)
