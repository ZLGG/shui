...
* @since 2020-12-06
*/
public abstract class BbbH5TradeRightsVO implements Serializable {

    @Data
    @ApiModel("BbbH5TradeRightsVO.ListVO")
    ...
    public static class ListVO implements Serializable{
        ...
        List<BbbH5TradeRightsVO.TradeRightsGoodsVO> tradeRightsGoodsVOS;

    }

    @Data
    @ApiModel("BbbH5TradeRightsVO.TradeGoodsVO")
    @Accessors(chain = true)
    ...
    @Data
    @ApiModel("BbbH5TradeRightsVO.DetailVO")
