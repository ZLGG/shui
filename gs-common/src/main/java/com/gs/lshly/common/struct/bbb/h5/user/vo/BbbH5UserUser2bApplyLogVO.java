...
* @since 2021-01-30
*/
public abstract class BbbH5UserUser2bApplyLogVO implements Serializable {

    @Data
    @ApiModel("BbbH5UserUser2bApplyLogVO.ListVO")
    ...
    @Data
    @ApiModel("BbbH5UserUser2bApplyLogVO.DetailVO")
