...
* @since 2020-12-15
*/
public abstract class PCMerchGoodsPosSkuLogDTO implements Serializable {

    @Data
    @ApiModel("PCMerchGoodsPosSkuLogDTO.ETO")
    @Accessors(chain = true)
    public static class ETO extends BaseDTO {

        @ApiModelProperty(value = "skupos素材库id",hidden = true)
        private String id;
    ...
    @Data
    @ApiModel("PCMerchGoodsPosSkuLogDTO.IdDTO")
    @AllArgsConstructor
    public static class IdDTO extends BaseDTO {

        @ApiModelProperty(value = "skupos素材库id")
        private String id;
    }
