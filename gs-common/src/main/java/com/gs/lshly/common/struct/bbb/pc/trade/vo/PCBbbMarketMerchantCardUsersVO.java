...
* @since 2021-01-08
*/
public abstract class PCBbbMarketMerchantCardUsersVO implements Serializable {

    @Data
    @ApiModel("PCBbbMarketMerchantCardUsersVO.ListVO")
    ...
    @Data
    @ApiModel("PCBbbMarketMerchantCardUsersVO.DetailVO")
    public static class DetailVO extends ListVO {

    }
    @Data
    @ApiModel("PCBbbMarketMerchantCardUsersVO.PageData")
