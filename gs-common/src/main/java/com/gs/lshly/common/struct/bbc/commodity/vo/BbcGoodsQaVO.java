...
public abstract class BbcGoodsQaVO implements Serializable {
    ...
    @Data
    @ApiModel("BbcGoodsQaVO.DetailVO")
    public static class DetailVO extends ListVO {

    }

    @Data
    @ApiModel("BbcGoodsQaVO.CountQuizVO")
