...
* @since 2020-12-06
*/
public abstract class BbbTradeRightsVO implements Serializable {

    @Data
    @ApiModel("BbbTradeRightsVO.ListVO")
    ...
    public static class ListVO implements Serializable{
        ...
        List<BbbTradeRightsVO.TradeRightsGoodsVO> tradeRightsGoodsVOS;

    }

    @Data
    @ApiModel("BbbTradeRightsVO.TradeGoodsVO")
    @Accessors(chain = true)
    ...
    @Data
    @ApiModel("BbbTradeRightsVO.DetailVO")
