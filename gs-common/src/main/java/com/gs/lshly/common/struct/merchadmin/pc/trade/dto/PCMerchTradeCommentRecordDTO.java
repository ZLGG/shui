...
* @since 2020-11-16
*/
public abstract class PCMerchTradeCommentRecordDTO implements Serializable {

    @Data
    @ApiModel("PCMerchTradeCommentRecordDTO.ETO")
    ...
    @Data
    @ApiModel("PCMerchTradeCommentRecordDTO.IdDTO")
    @AllArgsConstructor
