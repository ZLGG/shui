...
* @since 2021-01-15
*/
public abstract class H5BbbTradeInvoiceAddressQTO implements Serializable {

    @Data
    @ApiModel("H5BbbTradeInvoiceAddressQTO.QTO")
    ...
    @Data
    @ApiModel("H5BbbTradeInvoiceAddressQTO.IdQTO")
    @Accessors(chain = true)
