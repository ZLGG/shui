 ...
 */
public abstract class PCMerchGoodsQaDTO implements Serializable {
    @Data
    @ApiModel("PCMerchGoodsQaDTO.ETO")
    ...
    @Data
    @ApiModel("PCMerchGoodsQaDTO.IdDTO")
    @AllArgsConstructor
    ...
    @Data
    @ApiModel("PCMerchGoodsQaDTO.MerchantReplyETO")
    ...
    @Data
    @ApiModel("PCMerchGoodsQaDTO.ShowContentETO")
