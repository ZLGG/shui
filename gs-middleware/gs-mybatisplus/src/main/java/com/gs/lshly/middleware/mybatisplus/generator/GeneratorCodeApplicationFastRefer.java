 ...
 * @date 2018/10/19
 **/
public class GeneratorCodeApplicationFastRefer {
    ...
    public static void main(String[] args) {
        ...
        //数据为表格
        GeneratorConifg.strategy.setInclude("gs_shop_navigation_menu");
        //表格说明
        GeneratorConifg.setConfigIncludeDesc("店铺导航菜单");

        // foundation ,merchant,commodity,stock,trade,user
        GeneratorConifg.modelName = "merchant";
