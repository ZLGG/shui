package com.gs.lshly.facade.bbc.controller.pc.merchant;
...
*/
@RestController
@RequestMapping("/bbc/pc/merchant/pictures")
@Api(tags = "2C PC图片上传管理 : Starry")
public class BbcPcPicturesSettingController {
