package com.gs.lshly.facade.merchant.controller.h5.foundation;
...
*/
@RestController
@RequestMapping("/merchadmin/h5/remindMerchant")
@Api(tags = "商家消息提醒管理")
public class H5RemindMerchantController {

    @DubboReference
    private IRemindMerchantRpc remindMerchantRpc;

    @ApiOperation("商家消息提醒列表（只会查询未读状态的数据）")
    @GetMapping("")
