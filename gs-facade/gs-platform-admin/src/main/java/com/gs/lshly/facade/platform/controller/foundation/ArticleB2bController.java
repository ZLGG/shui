...
*/
@RestController
@RequestMapping("/platadmin/BBBdataArticle")
@Api(tags = "2B文章管理")
@Module(code = "listArticle2B", parent = "site", name = "2B文章列表", index = 11)
public class ArticleB2bController {
